      ...
      <div className="mx-auto max-w-5xl px-4">
        ...
        {categories.length > 0 && (
          <nav
            ...
            className="pb-2.5 flex items-center gap-1.5 overflow-x-auto scrollbar-none"
          >
            <Link
              href="/"
              className="shrink-0 text-xs font-medium text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors px-3 py-1 rounded-full hover:bg-[var(--muted)]"
            >
              Tümü
            </Link>
            {categories.map((cat) => (
